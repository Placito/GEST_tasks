		...
		<div className="container mt-5">
			<div className="box mt-5">
				...
				<div className="buttons">
					<button className="btn-tasks" type="submit">Consult</button>
					<button className="btn-tasks" type="submit">Add</button>
					<button className="btn-tasks" type="submit">Edit</button>
				</div>
			</div>
